...
void analyse()
{
  TGraph *graph1 = new TGraph("V_in_20000.txt", "%lg %lg");
  graph1->SetTitle("20000Hz Tensione-Tempo; tempo(s); tensione(V)");
  ...
  TF1 *f = new TF1("f", "[0] * TMath::Sin([1] * x + [2])", 46.704178, 46.704576);
  f->SetParameters(2.5, 20000 * TMath::TwoPi(), 0);
