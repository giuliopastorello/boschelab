...
void testFunction()
{
    TF1 *test = new TF1("test", "[0] * sin([1] * x)", 0.219837, 0.220832);
...
void analyse()
{
  TGraph *graph1 = new TGraph("V_in_1000.txt", "%lg %lg");
  ...
  TF1 *f = new TF1("f", "[0] * TMath::Sin([1] * x + [2])", 0.219837, 0.220832);
  f->SetParameters(2.5, 1000 * TMath::TwoPi(), 0);
