...
void analyse()
{
  TGraph *graph1 = new TGraph("tensione_tempo_7200.txt", "%lg %lg %*lg %*lg %*lg");
  graph1->SetTitle("7200Hz Tensione-Tempo; tempo(s); tensione(V)");
  ...
  TGraph *graph2 = new TGraph("tensione_tempo_7200.txt", "%lg %*lg %lg %*lg %*lg");
  ...
  TGraph *graph3 = new TGraph("tensione_tempo_7200.txt", "%lg %*lg %*lg %lg %*lg");
  ...
  TGraph *graph4 = new TGraph("tensione_tempo_7200.txt", "%lg %*lg %*lg %*lg %lg");
