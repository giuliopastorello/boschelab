...
void analyse()
{
  TGraph *graph1 = new TGraph("tensione_tempo_6800.txt", "%lg %lg %*lg %*lg %*lg");
  ...
  TGraph *graph2 = new TGraph("tensione_tempo_6800.txt", "%lg %*lg %lg %*lg %*lg");
  ...
  TGraph *graph3 = new TGraph("tensione_tempo_6800.txt", "%lg %*lg %*lg %lg %*lg");
  ...
  TGraph *graph4 = new TGraph("tensione_tempo_6800.txt", "%lg %*lg %*lg %*lg %lg");
